...
class ProductsList extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:  StreamBuilder(
          stream: Firestore.instance.collection('Category').document("SubCategory").collection(Categorypath).document('zzzzz').snapshots(),
          builder: (context, snapshot) {
            ...
            return Container(
                ...
                child: listloader(Categorypath,mail,"SubCategory",userDocument["length"])
            );
          }
      ),
