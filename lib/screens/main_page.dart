...
import 'package:nature_store/screens/ProductDetailsPage.dart';
                 ...
                 // mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text("Get the best", style: TextStyle(fontWeight: FontWeight.w600,
                    ...
                    Container(
                      ...
                      child: Text("From our store..", style: TextStyle(fontWeight: FontWeight.w600,
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedBuilder(
                                  ...
                                  child:StreamBuilder(
                                      ...
                                      stream: Firestore.instance.collection("Homepage").doc('SubHomepage').collection("onOffer").snapshots(),
                                      builder: (context, snapshot) {
                                        if (!snapshot.hasData) {
                                          return Text("Loading");
                                        }
                                        else {
                                           DocumentSnapshot productsa = snapshot.data.documents[index];
                                         //  var userDocument = snapshot.data;
                                          return    Container(
                                            decoration: BoxDecoration(
                                                color: Colors.black45,
                                                border: Border.all(color: Color(0xff0f4c81),width: 1),
                                            ...
                                            child: Stack(
                                              children: [
                                                ...
                                                Positioned(
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child:Container(
                                                      ...
                                                      child: Image.network(productsa["pic1"],fit: BoxFit.cover,),
                                                    ),
                                                ...
                                                Positioned(
                                                  ...
                                                  bottom: 40,
                                                  child: Container(
                                                    child: Text(productsa["name1"],style: TextStyle(fontFamily: "Spectral",fontSize: 20,color: Colors.white),),
                                                  ),
                                                ),
                                                Positioned(
                                                  left: 10,
                                                  bottom: 23,
                                                  child: Container(
                                                    child: Text(productsa["offer"]+"% off",style: TextStyle(fontFamily: "Spectral",fontSize: 18,color: Colors.white),),
                                                  ),
                                                ),
                                                Positioned(
                                                  left: 10,
                   ...
                   Swipperlayout(),
                    ...
                    Container(
                      ...
                      child:  Row(children: <Widget>[
                        Expanded(child: Text("Best Selling",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700,
                            fontFamily: "Spectral",color: Color(0xff0f4c81)),),),
                        GestureDetector(
                          onTap: (){
             ...
             child: Column(
               children: [
                 Container(
                   ...
                   child: Text("COVID Offer",style: TextStyle(
                       fontSize: 20,color: Colors.white,fontFamily: "Spectral"
                   ),),
                 ),
                 Container(
                   margin: EdgeInsets.only(top: 7,left: 10),

                   child: Text("Frouts and Vegitables cleaner",style: TextStyle(
                       fontSize: 15,color: Colors.white,fontFamily: "Spectral"
                   ),),
                 ),
                 Container(
                   margin: EdgeInsets.only(top: 10,left: 10),

                   child: Text("20% off in every item",style: TextStyle(
                       fontSize: 15,color: Colors.white,fontFamily: "Spectral"
                   ),),
                 ),
                 Container(
                   ...
                   color: Colors.white,
                   margin: EdgeInsets.only(top: 8,left: 10,bottom: 2),

                   child: Text("VIEW",style: TextStyle(
                       fontSize: 15,  color: Color(0xff0f4c81),fontFamily: "Spectral"
                   ),),
                 )
               ],
             ),
  ...
  Widget build(BuildContext context) {
    ...
    return  Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext ctxt, int index) {
            return   StreamBuilder(
                 stream: Firestore.instance.collection("Homepage").doc('SubHomepage').collection("offerCards").snapshots(),
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    return new Text("Loading");
                  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: DotPaginationSwiper(
        children: <Widget>[
          StreamBuilder(
              stream: Firestore.instance.collection("Homepage").doc('SubHomepage').collection("scrollingImage").doc("a").snapshots(),
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return Center(
                      child:  Container(
