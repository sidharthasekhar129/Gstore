...
class MyPointsPage extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Points"),backgroundColor: Color(0xff0f4c81)),
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              ...
              Text("Nstore",style: TextStyle(fontFamily: "Raleway",fontWeight: FontWeight.w700,fontSize: 20,color: Colors.white),),
            ],
          ),
          Container(
            margin: EdgeInsets.only(top: 30),
            child:Text("Total Nstore Points",textAlign: TextAlign.center,style: TextStyle(fontFamily: "Raleway",fontWeight: FontWeight.w700,fontSize: 18,color: Colors.white),),
          ),
          StreamBuilder(
