...
class CheckoutPage extends StatefulWidget{
  final pic1,pic2,pic3,pic4,name1,name2,oprice,fprice,offer,username,qty;


  CheckoutPage({Key key, this.pic1,this.pic2,this.pic3,this.pic4,this.name1,this.name2,this.oprice,this.fprice,this.offer,
    this.username,this.qty}) : super(key: key);

  @override
    _CheckoutPageState createState() => _CheckoutPageState(pic1,pic2,pic3,pic4,name1,name2,oprice,fprice,offer,username,qty);
}
class _CheckoutPageState extends State<CheckoutPage>{
  ProgressDialog pr;
  String pic1x,pic2x,pic3x,pic4x,name1x,name2x,opricex,fpricex,offerx,qtyx,usernamex;



  _CheckoutPageState(String pic1,String pic2,String pic3,String pic4,String name1,String name2,
      String oprice,String fprice,String offer,String mail,qty){
    pic1x=pic1;
    pic2x=pic2;
    pic3x=pic3;
    pic4x=pic4;
